...
public final class ConfiguracaoDbGlobal {
	...
	public static void setDbDriver(String dbDriver) {
		ConfiguracaoDbGlobal.dbDriver = dbDriver;
	}
	...
	public static void setDbURL(String dbURL) {
		ConfiguracaoDbGlobal.dbURL = dbURL;
	}
	...
	public static void setDbUsuario(String dbUsuario) {
		ConfiguracaoDbGlobal.dbUsuario = dbUsuario;
	}
	...
	public static void setDbSenha(String dbSenha) {
		ConfiguracaoDbGlobal.dbSenha = dbSenha;
	}
